...
set showtabline=2
set softtabstop=4
set statusline=%F%m%r%h%w\ [FORMAT=%{&ff}]\ [TYPE=%Y]\ [ASCII=%03.3b]\ [HEX=%02.2B]\ [POS=%04l,%04v][%p%%]\ [LEN=%L]%#warningmsg#%{SyntasticStatuslineFlag()}%*
set noswapfile
...
set shortmess=aoO
badd +1 ~/Dropbox/configs
badd +2 setup.sh
badd +42 Xstuff/Xdefaults
badd +5 zsh/alias.zsh
badd +4 .gitignore
badd +1 \[unite]\ -\ default
badd +19 vimStuff/vimrc
badd +143 vimStuff/vim/config/settings.vim
badd +91 vimStuff/vim/config/plugin.vim
badd +1 zsh/functions
badd +33 vimStuff/vim/plugged/vim-snippets/snippets/zsh.snippets
badd +17 vimStuff/vim/plugged/vim-snippets/UltiSnips/zsh.snippets
badd +2 zsh/zshrc
argglobal
silent! argdel *
argadd ~/Dropbox/configs
edit vimStuff/vim/plugged/vim-snippets/UltiSnips/zsh.snippets
...
17
normal! 0
lcd ~/Dropbox/configs/vimStuff/vim/plugged/vim-snippets/UltiSnips
wincmd w
argglobal
edit ~/Dropbox/configs/Xstuff/Xdefaults
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 42 - ((20 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
normal! 017|
lcd ~/Dropbox/configs/Xstuff
wincmd w
argglobal
edit ~/Dropbox/configs/zsh/zshrc
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
