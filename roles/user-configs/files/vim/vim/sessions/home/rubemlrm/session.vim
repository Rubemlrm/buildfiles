...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 43 + 43) / 86)
exe 'vert 2resize ' . ((&columns * 42 + 43) / 86)
argglobal
enew
file \[Plugins]
...
setlocal statusline=%{lightline#link()}%#LightlineLeft_active_0#%(\ %{LightlineMode()}\ %)%{LightlineMode()!=#\"\"&&((&paste))?\"\":\"\"}%(\ %{&paste?\"PASTE\":\"\"}\ %)%#LightlineLeft_active_0_1#%#LightlineLeft_active_1#%(\ %{LightlineFugitive()}\ %)%{LightlineFugitive()!=#\"\"&&(LightlineFilename()!=#\"\")?\"\":\"\"}%(\ %{LightlineFilename()}\ %)%#LightlineLeft_active_1_2#%#LightlineLeft_active_2#%(\ %{exists(\"*CtrlPMark\")?CtrlPMark():\"\"}\ %)%#LightlineLeft_active_2_3#%#LightlineMiddle_active#%=%#LightlineRight_active_2_3#%#LightlineRight_active_2#%(\ %{LightlineFileformat()}\ %)%{LightlineFileformat()!=#\"\"&&(LightlineFileencoding()!=#\"\"||LightlineFiletype()!=#\"\")?\"\":\"\"}%(\ %{LightlineFileencoding()}\ %)%{LightlineFileencoding()!=#\"\"&&(LightlineFiletype()!=#\"\")?\"\":\"\"}%(\ %{LightlineFiletype()}\ %)%#LightlineRight_active_1_2#%#LightlineRight_active_1#%(\ %3p%%\ %)%#LightlineRight_active_0_1#%#LightlineRight_active_0#%{0&&(1)?\"\":\"\"}%(\ %3l:%-2v\ %)
