...
silent only
cd ~/works/web/trypyramid/ra
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +51 ra/templates/layout.jinja2
badd +6 ra/__init__.py
badd +1 ra/templates/mytemplate.jinja2
badd +1 ra/views.py
badd +13 ra/tests.py
badd +17 development.ini
badd +8 package/setup.py
badd +1 package/__init__.py
badd +1 package/tutorial/app.py
argglobal
silent! argdel *
...
let s:l = 17 - ((11 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
normal! 0
lcd ~/works/web/trypyramid/ra
tabnext 1
if exists('s:wipebuf')
